...
| **[modo-baixa-latencia.md](modo-baixa-latencia.md)** | Especificação do modo de baixa latência por parâmetros (v1) e por troca do detector (v2): cada mudança, o ganho, o custo, os números por preset de voz e **seis questões em aberto**. ⏸️ Superado pela v3 — ver [especificacao-v3-ponteiro.md](especificacao-v3-ponteiro.md). | Para entender por que a v3 troca o motor de síntese em vez de seguir por aqui. |
